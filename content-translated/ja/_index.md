...
{{<feature title="レイヤを編集する" text="強力なデジタイジング・作図ツールが持つ、他に類を見ない機能をご活用ください。" col-title-1="比類なきデジタイジング機能" col-text-1="ポイント・ライン・ポリゴン・メッシュを高精度で作成・編集しましょう。" col-title-2="高機能な作図ツール" col-text-2="カーブやCAD風ツール、充実したジオメトリ変換機能を活用して、高度なジオメトリを作成しましょう。

 " col-title-3="高度にカスタマイズ可能なフォーム" col-text-3="フォームデザイナーを使用して、使いやすいフォームを作成できます。" img="img/main-edit.webp" order=2 >}}
