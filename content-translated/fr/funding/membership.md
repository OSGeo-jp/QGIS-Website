...
ButtonText: Devenez membre bienfaiteur
HasBanner: true
...
draft: false
sidebar: true
subtitle: Soutenez le développement de QGIS, un outil indispensable pour la communauté
  SIG mondiale.
title: Programme d'adhésion de soutien
type: page
...
### 27 000 € et plus
Membre phare (par exemple, pour les entreprises de plus de 100 salariés, les organismes gouvernementaux fédéraux) {{< rich-content-end >}} {{< rich-box-end >}}
